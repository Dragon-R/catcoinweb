<?php include("template/cabecera.php"); ?>
    ...
    <div id="index" class="container">
        <div class="row">
            <div id="video" class="col-7">
                VIDEO DE PRESENTACIÓN
            </div>
            <div id="texto" class="col-5">
            Juega de 2 o más participantes. <br>
            Compiten todos contra todos. <br>
            El último en quedar vivo se llevará todo el botín. <br>
